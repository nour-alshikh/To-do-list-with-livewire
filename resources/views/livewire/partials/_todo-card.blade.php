   <div wire:key={{ $todo->id }}
       ...
       <div class="flex justify-between space-x-2">
           ...
           <div class="flex items-center">
               <input wire:click="toggleCompleted({{ $todo->id }})" type="checkbox" class="mx-3"
               ...
               @else
                   <h3
                       class="text-lg text-semibold text-gray-800 transition  @if ($todo->completed) line-through @endif">
                       {{ $todo->name }}</h3>
               @endif
